...
import { Search, Image, FileText, Video, File, Music, Archive, CheckCircle2, AlertCircle, LayoutGrid, FolderSearch } from 'lucide-react';
...
export const FilePreview: React.FC<Props> = ({ files, hasAnalyzed }) => {
  ...
  const getCategoryIcon = (category: string) => {
    switch (category) {
      ...
      case 'PDFs':     return <FileText className="w-4 h-4" style={{ color: '#f87171' }} />;
      case 'Videos':   return <Video    className="w-4 h-4" style={{ color: '#60a5fa' }} />;
      case 'Docs':     return <FileText className="w-4 h-4" style={{ color: '#90cdf4' }} />;
